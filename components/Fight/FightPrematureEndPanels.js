    ...
    return (
      <Container>
        <Content style={ { marginTop: 25 } }>
          <FightHeader fight={ fight } user={ user } started={ false } />
          { this.props.isAdmin ? (
            <Grid>
              <Col>
          ...
          <Grid>
            <PrematureEndPanel primaryBackgroundColor='#cd2626' secondaryBackgroundColor='#720000' playerName={ redFighterName } sendMessage={ this.props.sendMessage } roundEndTime={ this.props.roundEndTime }
              fighterId={ fight.redAthlete.id } judgeId={ user.id } roundId={ this.props.roundId } fightId={ fight.id } disabled={ this.state.disabled } setDisable={ this.setDisable.bind(this) }
            />
            <PrematureEndPanel primaryBackgroundColor='#1874cd' secondaryBackgroundColor='#000080' playerName={ blueFighterName } sendMessage={ this.props.sendMessage } roundEndTime={ this.props.roundEndTime }
              fighterId={ fight.blueAthlete.id } judgeId={ user.id } roundId={ this.props.roundId } fightId={ fight.id } disabled={ this.state.disabled } setDisable={ this.setDisable.bind(this) }
            />
          </Grid>
        </Content>
      </Container>
