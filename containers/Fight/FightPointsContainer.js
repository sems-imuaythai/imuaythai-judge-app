...
class FightPointsContainer extends Component {
    ...
    render() {
        ...
        if (this.state.showPrematureEndPanels)
            return (<FightPrematureEndPanels fight={ this.props.fight } user={ this.props.user } sendMessage={ this.props.sendMessage } fightStarted={ this.state.fightStarted } roundId={ this.state.roundId }
                      logout={ this.props.logout } sendMessage={ this.props.sendMessage } message={ parsedMessage } roundEndTime={ this.state.roundEndTime } />)
        else
            return (
                <MyDrawer content={ <FightPointsHistoryContainer/> }>
                  <FightPointsView fightStarted={ this.state.fightStarted } fight={ this.props.fight } user={ this.props.user } message={ parsedMessage } sendMessage={ this.props.sendMessage }
                    showPanels={ this.showPanels.bind(this) } setRound={ this.setRound.bind(this) } clearMessage={ this.props.clearMessage } roundId={ this.state.roundId } setRoundEndTime={ this.setRoundEndTime.bind(this) }
                    logout={ this.props.logout } togglePause={ this.togglePause.bind(this) } pauseRound={ this.state.pauseRound } addToHistory={ this.props.addToHistory } />
                </MyDrawer>
